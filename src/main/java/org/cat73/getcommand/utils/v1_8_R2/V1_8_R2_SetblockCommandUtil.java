package org.cat73.getcommand.utils.v1_8_R2;
...
public class V1_8_R2_SetblockCommandUtil implements ISetblockCommandUtil {
    @Override
    public String getBlockSetBlockAtCommand(final Block block) throws Exception {
        ...
        // 获取附加数据标签
        final String dataTag = V1_8_R2_SetblockCommandUtil.getDataTag(block);
        // 拼凑 setblock 命令
    ...
    public static String getDataTag(final Block block) throws Exception {
        ...
        ReflectUtil.invokeMethod(tileEntityClass, tileEntity, "b", NBTTagCompound);
